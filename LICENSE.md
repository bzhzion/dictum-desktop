> **Portee sur ce depot.** Cette licence couvre le code produit ici. Elle ne couvre **pas**
> les binaires whisper.cpp et ggml que l'application telecharge a l'execution, ni le moteur
> processeur que l'installateur Windows embarque : ils viennent de `ggml-org/whisper.cpp` et
> restent sous leur **licence MIT** d'origine, reproduite dans `NOTICE.md`. Elle ne couvre pas
> davantage les modeles Whisper, qui appartiennent a OpenAI et sont distribues sous MIT.
